import { Objectish, Drafted, AnyObject, AnyArray, AnyMap, AnySet, ImmerState, Archtype } from "./internal";
...
export declare function original<T>(value: Drafted<T>): T | undefined;
