...
function Commits(_ref) {
  ...
  return __jsx(_layouts_MainLayout__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    sections: [{
      label: 'Content',
      href: "/p/".concat(query.proposal).concat(query.branch && query.branch !== 'master' ? "/branch/".concat(query.branch) : '')
    }, {
      label: 'Commits',
...
//# sourceMappingURL=[branch].js.2ef9e615fa05d5943858.hot-update.js.map