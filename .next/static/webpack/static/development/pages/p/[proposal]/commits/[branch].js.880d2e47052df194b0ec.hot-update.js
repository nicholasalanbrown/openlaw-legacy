...
function Commits(_ref) {
  ...
  return __jsx(_layouts_MainLayout__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    sections: [{
      label: 'Content',
      href: "/p/".concat(query.proposal).concat(query.branch && query.branch !== 'master' ? "/".concat(query.branch) : '')
    }, {
      label: 'Commits',
...
//# sourceMappingURL=[branch].js.880d2e47052df194b0ec.hot-update.js.map