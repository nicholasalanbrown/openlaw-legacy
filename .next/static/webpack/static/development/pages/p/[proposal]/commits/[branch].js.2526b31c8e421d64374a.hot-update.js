...
function Commits(_ref) {
  ...
  return __jsx(_layouts_MainLayout__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    sections: [{
      label: 'Content',
      href: "/p/".concat(query.proposal).concat(query.branch && query.bracnh !== 'master' && "/".concat(query.branch))
    }, {
      label: 'Commits',
...
//# sourceMappingURL=[branch].js.2526b31c8e421d64374a.hot-update.js.map