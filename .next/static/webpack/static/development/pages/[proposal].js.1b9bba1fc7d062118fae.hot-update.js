    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          res = isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_1___default()("".concat("http://127.0.0.1:30080/api/v4", "/projects/").concat(gitlabProjectId, "/repository/files/content%2Emd/raw?ref=").concat(refName)).then(function (response) {
...
//# sourceMappingURL=[proposal].js.1b9bba1fc7d062118fae.hot-update.js.map